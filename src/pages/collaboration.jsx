...
const verticalCollabs = [
  ...
  { vertical: "Claims & Operations",initiatives: 4, platforms: ["Guidewire", "SmartCOMM"],  highlight: "GenAI claims triage POC running in sandbox environment", contentAccessRole: CONTENT_ACCESS_ROLE.GENERAL },
];
...
const otherTSCs = [
  ...
  { name: "Digital Experience TSC",      collab: "Omnichannel CX, portal modernisation",            status: "Active", contentAccessRole: getContentAccessRoleForPlatform("SmartCOMM") },
